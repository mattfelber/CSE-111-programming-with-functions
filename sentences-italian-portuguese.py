...
def main():
    for _ in range(6):  # Generating sentences for different tenses and quantities
        sentence = make_sentence(1, "passato")
        translate_and_print(sentence)
        sentence = make_sentence(1, "presente")
        translate_and_print(sentence)
        sentence = make_sentence(1, "futuro")
        translate_and_print(sentence)
        sentence = make_sentence(2, "passato")
        translate_and_print(sentence)
        sentence = make_sentence(2, "presente")
        translate_and_print(sentence)
        sentence = make_sentence(2, "futuro")
        translate_and_print(sentence)
...
def make_sentence(quantity, tense):
    ...
    return f"{determiner} {adjective} {noun} {adverb} {verb} {prepositional}."

def translate_and_print(sentence):
    translation = translator.translate(sentence, src='it', dest='pt').text
    print(f"Italiano: {sentence}")
    print(f"Portugues: {translation}\n")
